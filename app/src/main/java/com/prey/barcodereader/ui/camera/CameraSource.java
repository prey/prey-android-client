...
public class CameraSource {
        ...
        synchronized (mCameraLock) {
            ...
            if (mProcessingThread != null) {
                try {
                    ...
                    PreyLogger.Companion.e("Frame processing thread interrupted on release.",e);
                }
            ...
            if (mCamera != null) {
                ...
                try {
                    ...
                    PreyLogger.Companion.e("Failed to clear camera preview: " + e.getMessage(),e);
                }
                mCamera.release();
                mCamera = null;
            }
    ...
    public int doZoom(float scale) {
        synchronized (mCameraLock) {
            ...
            if (!parameters.isZoomSupported()) {
                PreyLogger.Companion.d("Zoom is not supported on this device");
                return currentZoom;
            }
    ...
    private Camera createCamera() {
        ...
        if (mFocusMode != null) {
            if (parameters.getSupportedFocusModes().contains(
                ...
                PreyLogger.Companion.d("Camera focus mode: " + mFocusMode + " is not supported on this device.");
            }
        }
        ...
        if (mFlashMode != null) {
            if (parameters.getSupportedFlashModes().contains(
                ...
                PreyLogger.Companion.d("Camera flash mode: " + mFlashMode + " is not supported on this device.");
            }
        }
    ...
    private static List<SizePair> generateValidPreviewSizeList(Camera camera) {
        ...
        if (validPreviewSizes.size() == 0) {
            PreyLogger.Companion.d("No preview sizes have a corresponding same-aspect-ratio picture size");
            for (Camera.Size previewSize : supportedPreviewSizes) {
    ...
    private void setRotation(Camera camera, Camera.Parameters parameters, int cameraId) {
        ...
        switch (rotation) {
            ...
            case Surface.ROTATION_270:
                ...
                break;
            default:
                PreyLogger.Companion.d("Bad rotation value: " + rotation);
        }
        CameraInfo cameraInfo = new CameraInfo();
        ...
        public void run() {
            ...
            while (true) {
                synchronized (mLock) {
                    while (mActive && (mPendingFrameData == null)) {
                        try {
                            ...
                            PreyLogger.Companion.e("Frame processing loop terminated.", e);
                            return;
                        }
                    }
                    if (!mActive) {
                ...
                try {
                    ...
                    PreyLogger.Companion.e("Exception thrown from receiver.", t);
                } finally {
