...
import com.prey.R
import com.prey.activities.js.kotlin.CustomWebView
...
import com.prey.services.kotlin.PreyAccessibilityService
import com.prey.services.kotlin.PreyOverlayService
import java.io.File
...
class CheckPasswordHtmlActivity() : AppCompatActivity() {
    ...
    fun tryReport() {
        ...
        myWebView!!.addJavascriptInterface(
            com.prey.activities.js.kotlin.WebAppInterface(applicationContext, this),
    ...
    fun security() {
        ...
        settings()
        PreyLogger.d(String.format("_url:%s", url.toString()))
        myWebView!!.addJavascriptInterface(com.prey.activities.js.kotlin.WebAppInterface(applicationContext, this), JS_ALIAS)
        myWebView!!.loadUrl(url.toString())
        myWebView!!.loadUrl("javascript:window.location.reload(true)")
    }
