...
import com.prey.net.kotlin.PreyHttpResponse
import com.prey.net.kotlin.PreyWebServices
import com.prey.receivers.kotlin.AwareGeofenceReceiver
...
class AwareController {
    ...
    fun sendAware(context: Context, currentLocation: PreyLocation?): PreyLocation? {
        ...
        val mustSendAware = mustSendAware(context, previousLocation, currentLocation, distanceAware)
        //send aware
    ...
    companion object {
        ...
        fun getInstance(): AwareController {
            if (AwareController.instance == null) {
                AwareController.instance = AwareController()
            }
            return AwareController.instance!!
        }
    }
}