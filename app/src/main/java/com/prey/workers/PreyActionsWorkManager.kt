...
private constructor() {
    ...
    companion object {
        const val WORK_NAME: String = "prey_actions_work_manager"
        private var instance: PreyActionsWorkManager? = null
        fun getInstance(): PreyActionsWorkManager {
            if (instance == null) {
                instance = PreyActionsWorkManager()
            }
            return instance!!
        }
    }
