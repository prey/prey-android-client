...
import com.prey.actions.aware.kotlin.AwareScheduled
...
import com.prey.actions.location.daily.kotlin.LocationScheduled
import com.prey.actions.report.kotlin.ReportScheduled
import com.prey.actions.report.kotlin.ReportService
import com.prey.actions.triggers.kotlin.TriggerController
...
import com.prey.events.receivers.kotlin.EventReceiver
import com.prey.net.kotlin.PreyWebServices
import com.prey.preferences.kotlin.RunBackgroundCheckBoxPreference
import com.prey.services.kotlin.AwareJobService
import com.prey.services.kotlin.PreyDisablePowerOptionsService
import com.prey.services.kotlin.PreyJobService
import com.prey.workers.kotlin.PreyWorker
            ...
            if (deviceKey != null && "" != deviceKey) {
                object : Thread() {
                    override fun run() {
                        ...
                        if (missing) {
                            if (PreyConfig.getInstance(ctx).getIntervalReport() != null && "" != PreyConfig.getInstance(
                                    ctx
                                ).getIntervalReport()
                            ) {
