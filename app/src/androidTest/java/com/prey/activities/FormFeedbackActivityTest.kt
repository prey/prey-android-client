...
@LargeTest
class FormFeedbackActivityTest {

    private val context: Context = ApplicationProvider.getApplicationContext()
    lateinit var scenario: ActivityScenario<FormFeedbackActivity>

    private fun withWebFormIntent(context: Context): Intent {
        return Intent(context, FormFeedbackActivity::class.java)
    }
    ...
    fun test_privacy_withWebForm() {
        ...
        assertEquals(activityView, FormFeedbackActivity.ACTIVITY_FORM_FEEDBACK)
    }
