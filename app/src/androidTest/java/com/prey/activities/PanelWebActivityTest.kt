...
@LargeTest
class PanelWebActivityTest {

    private val context: Context = ApplicationProvider.getApplicationContext()
    lateinit var scenario: ActivityScenario<PanelWebActivity>
    ...
    fun test_permission_withWebForm() {
        ...
        PreyConfig.getInstance(context).setTokenJwt("1234")
        ...
        assertEquals(activityView, PanelWebActivity.ACTIVITY_PANEL_FORM)
    }
