...
@LargeTest
class DeviceReadyActivityTest {

    private val context: Context = ApplicationProvider.getApplicationContext()
    lateinit var scenario: ActivityScenario<DeviceReadyActivity>

    private fun withWebFormIntent(context: Context): Intent {
        return Intent(context, DeviceReadyActivity::class.java)
    }
    ...
    fun test_device_ready_withWebForm() {
        ...
        assertEquals(activityView, DeviceReadyActivity.DEVICE_READY_FORM)
    }
