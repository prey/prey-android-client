	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		iconBack.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = null;
				intent = new Intent(CheckPasswordActivity.this, LoginActivity.class);
        ...
        keyboard.setVisibilityListener(new KeyboardVisibilityListener() {
			...
			public void onVisibilityChanged(boolean keyboardVisible) {
		        ...
		        TextView  textReady2=(TextView)findViewById(R.id.device_ready_h2_text);
				...
				if(keyboardVisible) {
                    ...
                    if(textReady2!=null)
                    	textReady2.setVisibility(View.GONE);
                 }else {
